...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        default: {
          lineActive: isLight ? { r: 0, g: 0, b: 0, a: 0.9 } : { r: 74, g: 158, b: 255, a: 0.9 },
          nodeActive: isLight ? { r: 0, g: 0, b: 0, a: 1.0 } : { r: 74, g: 158, b: 255, a: 1.0 },
          glow: isLight ? "0,0,0" : "74,158,255",
          ripple: isLight ? "0,0,0" : "100,180,255",
          dot: isLight ? "rgba(0,0,0,0.05)" : "rgba(255,255,255,0.05)",
          lineBase: isLight ? { r: 0, g: 0, b: 0, a: 0.13 } : { r: 255, g: 255, b: 255, a: 0.13 },
          nodeBase: isLight ? { r: 0, g: 0, b: 0, a: 0.2 } : { r: 255, g: 255, b: 255, a: 0.2 }
        },
        monochrome: {
    ...
    [getWarpedPoint, globalColor, resolvedTheme],
  );
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-screen overflow-clip",
